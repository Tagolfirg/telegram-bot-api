...
class StickerTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testGetThumb()
    {
        ...
        $this->assertInstanceOf('\YaroslavMolchan\TelegramBotApi\Types\PhotoSize', $sticker->getThumb());
    }
    ...
    public function testFromResponse()
    {
        ...
        $this->assertInstanceOf('\YaroslavMolchan\TelegramBotApi\Types\Sticker', $sticker);
